...
class QuickSearchSpecificByIdRequest(ApiBaseModel):
    ...
    selectedSortByFieldId: Optional[str] = None
...
class SearchResultsTableResponse(ApiBaseModel):
    columns: Optional[List[FieldModel]] = None
...
class SearchResultsResponse(ApiBaseModel):
    ...
    searchResultsFields: Optional[List[FieldModel]] = None
...
SearchFolder.update_forward_refs()
